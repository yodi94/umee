...
function installCosmovisor {
	...
	useradd --no-create-home --shell /bin/false cosmovisor#!/bin/bash
# wget -q -O https://raw.githubusercontent.com/yodi94/umee/main/um.shchmod +x um.sh && sudo /bin/bash um.sh
